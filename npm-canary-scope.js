    ...
    53: function(e, t, o) {
      ...
      function l(e, t, o, a) {
        ...
        if (1 === i) t.children = a;
          ...
          for (var c = new Array(i), l = 0; l < i; l++) c[l] = arguments[l + 3];
          t.children = c;
        }
        return {
          $$typeof: r,
      ...
      const h = e => {
        ...
        return t.includes('http')
          ? s.default.createElement('a', u({}, e, { href: t }))
          : ('#' === t[0] &&
              (t = a.default.join('/auto/', 'blog/npm-canary-scope.html') + t),
      ...
      class f extends s.default.Component {
        constructor(...e) {
          super(...e),
            d(this, 'state', { image: null, ImageProvider: v[this.props.src] });
        }
        componentDidMount() {
          this.state.image ||
      ...
      const m = e => {
        var t, o;
        return (
          (o = t = class extends s.default.Component {
            constructor(...e) {
      ...
      m(() => o.e(31).then(o.bind(null, 107))),
        m(() => o.e(31).then(o.bind(null, 108)));
      var b = l(f, {
        ...
        y = l('span', {}, void 0, ' on December 13, 2019', l('span', {})),
        w = l(
          'p',
          {},
          void 0,
        ...
        k = l(
          ...
          {},
          void 0,
          'Depending on the build platform you might be able to pass secrets to PR builds for forked repos. While this makes the developer experience of your project nice, in ',
          l('code', {}, void 0, 'auto'),
        ...
        P = l(
          ...
          void 0,
          l(h, { to: '/auto/blog/npm-canary-scope.html' }, void 0, 'Read More')
        ),
        N = l(f, {
          src: '//www.gravatar.com/avatar/ff725a631f869cdb78beeb003825bb40',
          className: 'authorImage'
        ...
        O = l('span', {}, void 0, ' on December 13, 2019', l('span', {})),
        S = l(
          'p',
          {},
          void 0,
        ...
        C = l('p', {}, void 0, 'An attacker could:'),
        I = l(
          'ol',
          {},
          void 0,
          l('li', {}, void 0, 'print secrets'),
          l('li', {}, void 0, 'send secrets to some server'),
          l(
            'li',
            {},
            void 0,
            'modify ',
            l('code', {}, void 0, 'auto'),
            ' to publish to the latest tag instead of ',
            l('code', {}, void 0, 'canary')
          )
        ),
        M = l(
          'p',
          {},
          void 0,
          "No amount of code can fix these problems. If your release keys are in everyone's CI builds an attacker can do any number of things to modify what you intend for ",
          l('code', {}, void 0, 'auto'),
        ...
        D = l(
          ...
          l(
            ...
            l('code', {}, void 0, '@auto-canary'),
            ' or ',
            l('code', {}, void 0, '@auto-test'),
            ')'
          ),
          l(
            'li',
        ...
        T = l(
          ...
          l(
            ...
            l('br', {}),
            '  ',
            l('span', { className: 'hljs-attr' }, void 0, '"plugins"'),
            ': [',
            l('br', {}),
            '    [',
            l('br', {}),
            '      ',
            l('span', { className: 'hljs-string' }, void 0, '"npm"'),
            ',',
            l('br', {}),
            '      {',
            l('br', {}),
            '        ',
            l('span', { className: 'hljs-attr' }, void 0, '"canaryScope"'),
            ': ',
            l('span', { className: 'hljs-string' }, void 0, '"@auto-canary"'),
            l('br', {}),
            '      }',
            l('br', {}),
            '    ]',
        ...
        H = l(
          ...
          l(
            ...
            l('code', {}, void 0, 'canaryScope')
          )
        );
      var B = class extends s.default.Component {
        componentDidMount() {
          this.props.atIndex ||
            window.configuration.setBlogHero(
              'https://images.unsplash.com/photo-1566386087068-55645996b234?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=500&ixid=eyJhcHBfaWQiOjF9&ixlib=rb-1.2.1&q=80&w=1950'
            );
        }
        render() {
          return l(
