    ...
    81: function(e, t, o) {
      ...
      function d(e, t, o, r) {
        ...
        if (1 === n) t.children = r;
          ...
          for (var l = new Array(n), s = 0; s < n; s++) l[s] = arguments[s + 3];
          t.children = l;
        }
        return {
          $$typeof: a,
      ...
      const c = e => {
        ...
        return t.includes('http')
          ...
          : ('#' === t[0] &&
              (t = r.default.join('/auto/', 'pages/generated/init.html') + t),
      ...
      var p = d('h1', {}, void 0, 'Initialization'),
        v = d('code', {}, void 0, 'auto'),
        f = d('code', {}, void 0, 'init'),
        m = d(
          'p',
          {},
          void 0,
        ...
        g = d(
          ...
          d(
            ...
            d(
              ...
              {},
              void 0,
              d('td', {}, void 0, d('code', {}, void 0, '--only-labels')),
              d('td', {}, void 0, 'Boolean'),
              d(
                'td',
                {},
        ...
        j = d(
          ...
          d(
            ...
            d(
              ...
              {},
              void 0,
              '⚠️ For this to work you must have a ',
              d('code', {}, void 0, 'GH_TOKEN'),
              ' set, ex: ',
              d('code', {}, void 0, 'GH_TOKEN=YOUR_TOKEN auto create-labels')
            )
          )
        );
      var k = e =>
        d(
          ...
          d(
            ...
            d(
              ...
              void 0,
              v,
              ' provides some tools to quickly set up your project. If you do not want to use the interactive experience all these options can be configured via the ',
              d(
                c,
                {
                  currentPage: e.currentPage,
                  to: '/auto/pages/generated/autorc.html'
                },
                void 0,
                '.autorc'
              ),
              ' and most can be configure via CLI options.'
            ),
            d(
              'h3',
              { id: 'init' },
