  ...
  [49],
  {
    57: function(e, t, o) {
      ...
      function l(e, t, o, n) {
        ...
        if ((t || 0 === r || (t = { children: void 0 }), t && i))
      ...
      const c = e => {
        ...
        return t.includes('http')
          ...
          : ('#' === t[0] &&
              (t = n.default.join('/auto/', 'blog/why.html') + t),
            i.default.createElement(
              ...
              u({}, o, {
                ...
                onClick: o => {
                  ...
                  const a = new URL(n.default.join(window.location.origin, t));
                  window.history.pushState(
                    ...
                    e.onClick();
                  const i = new CustomEvent('changeLocation', { detail: a });
      ...
      var m = l(
        ...
        f = l('span', {}, void 0, ' on May 3, 2019', l('span', {})),
        g = l('h1', {}, void 0, 'How auto can “handle the rest for you”'),
        b = l('hr', {}),
        w = l(
          'div',
          { className: 'has-text-centered learnMore' },
          void 0,
          l(c, { to: '/auto/blog/why.html' }, void 0, 'Read More')
        ),
        v = l(
          'p',
          { className: 'title blogTitle' },
        ...
        y = l('span', {}, void 0, ' on May 3, 2019', l('span', {})),
        k = l('h1', {}, void 0, 'How auto can “handle the rest for you”'),
        P = l('hr', {}),
        x = l(
          'p',
          {},
      ...
      var D = class extends i.default.Component {
        componentDidMount() {
          this.props.atIndex ||
            window.configuration.setBlogHero(
              'https://cdn-images-1.medium.com/max/800/1*TVSbt7qsyleNiQ84la_log.jpeg'
            );
        }
        render() {
          return l(
            'div',
            { className: (0, r.default)('blogPost', this.props.className) },
            void 0,
            l('p', {}, void 0, this.props.heroUrl),
            l(
              'section',
              {},
              void 0,
                    ...
                    l(
                            ...
                            l(
                              c,
                              {
                                currentPage: ((this && this.props) || props)
                                  .currentPage,
                                target: '_blank',
                                to: 'https://github.intuit.com/adierkens'
                              },
                              void 0,
                              'Adam Dierkens'
                            ),
                      ...
                      l(
                        ...
                        l(
                          ...
                          {},
                          void 0,
                          'I’ve been a front-end engineer at Intuit in San Diego for the past three years. As one of three members of Intuit’s Player team, we are responsible for delivering a JavaScript framework dedicated to rendering most of a user’s experience in ',
                          l(
                            c,
                            {
                              currentPage: ((this && this.props) || props)
                          ...
                          l(
                            c,
                            {
                              currentPage: ((this && this.props) || props)
                                .currentPage,
                              target: '_blank',
                              to: 'https://github.com/intuit/auto',
                              className: 'external-link'
                            },
                            void 0,
                      ...
                      l(
                        ...
                        l(
                          ...
                          l(
                            ...
                            {},
                            void 0,
                            'I brought in another engineer on my team, ',
                            l(
                              c,
                              {
                                currentPage: ((this && this.props) || props)
                                ...
                                target: '_blank',
                                to:
                                  'https://www.linkedin.com/in/andrew-lisowski-8b419977/',
                                className: 'external-link'
                              },
                              void 0,
                              'Andrew Lisowski'
                            ),
                            ', and we spent the next few months building out the script into a proper npm module. We gave it a well-defined API comprised of small atomic operations that could handle all parts of the release. With auto, the new process is entirely hands-off — simply hit “merge”, and everything happens automatically.'
                          ),
                          O,
                          j,
                          l(
                            ...
                            {},
                            void 0,
                            'Inspired by the power and modularity of webpack’s plugin architecture, we brought in their tap-able module, the core code that powers their plugins. Andrew and I spent about a month slowly refactoring the code to leverage the plugin-based architecture you see today. It went live on ',
                            l(
                              c,
                              {
                                currentPage: ((this && this.props) || props)
                            ...
                            ' in December 2018 and has since attracted several outside contributors.'
                          ),
                          q,
                          T,
                          A,
