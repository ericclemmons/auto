  ...
  [3],
  {
    52: function(e, t, o) {
      ...
      function c(e, t, o, s) {
        ...
        if ((t || 0 === i || (t = { children: void 0 }), t && r))
      ...
      const u = e => {
        ...
        return t.includes('http')
          ? r.default.createElement('a', d({}, e, { href: t }))
          : ('#' === t[0] &&
              (t = s.default.join('/auto/', 'blog/both-worlds.html') + t),
            r.default.createElement(
              ...
              d({}, o, {
                ...
                onClick: o => {
                  ...
                  const a = new URL(s.default.join(window.location.origin, t));
                  window.history.pushState(
                    ...
                    e.onClick();
                  const r = new CustomEvent('changeLocation', { detail: a });
      ...
      const m = {
        ...
        'https://i.giphy.com/media/cjYH0IhoWiQk8/giphy.webp': () =>
          Promise.resolve({
            default: {
              src: {
                src: 'https://i.giphy.com/media/cjYH0IhoWiQk8/giphy.webp'
              },
              preSrc: 'https://i.giphy.com/media/cjYH0IhoWiQk8/giphy.webp',
              height: 263,
              width: 350
            }
          })
      };
      class b extends r.default.Component {
        constructor(...e) {
          super(...e),
            p(this, 'state', { image: null, ImageProvider: m[this.props.src] });
        }
        componentDidMount() {
          this.state.image ||
      ...
      const f = e => {
        var t, o;
        return (
          (o = t = class extends r.default.Component {
            constructor(...e) {
              super(...e), p(this, 'state', { Comp: null });
            }
            componentDidMount() {
              !this.state.Comp &&
          ...
          p(t, 'defaultProps', { shouldLoad: !0 }),
          o
        );
      };
      f(() => o.e(31).then(o.bind(null, 107))),
        f(() => o.e(31).then(o.bind(null, 108)));
      var g = c(b, {
        ...
        w = c('span', {}, void 0, ' on May 9, 2019', c('span', {})),
        y = c(
          'p',
          {},
          void 0,
        ...
        N = c(
          ...
          void 0,
          c(u, { to: '/auto/blog/both-worlds.html' }, void 0, 'Read More')
        ),
        j = c(b, {
          src: '//www.gravatar.com/avatar/ff725a631f869cdb78beeb003825bb40',
          className: 'authorImage'
        ...
        O = c('span', {}, void 0, ' on May 9, 2019', c('span', {})),
        x = c(
          'p',
          {},
          void 0,
        ...
        _ = c(
          ...
          c(
            ...
            c('br', {}),
            '  ',
            c('span', { className: 'hljs-attr' }, void 0, '"plugins"'),
            ': [',
            c(
              'span',
        ...
        C = c('p', {}, void 0, 'Now you can enjoy the best of both worlds! 🎉');
      var H = class extends r.default.Component {
        componentDidMount() {
          this.props.atIndex ||
            window.configuration.setBlogHero(
              'https://images.unsplash.com/photo-1554916171-0cfab61e5607?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1200&h=600&fit=crop&ixid=eyJhcHBfaWQiOjF9'
            );
        }
        render() {
          return c(
                    ...
                    c(
                      ...
                      c(
                        ...
                        c(
                          ...
                          {},
                          void 0,
                          'The main alternative to auto works in a slightly different way, ',
                          c(
                            u,
                            {
                              currentPage: ((this && this.props) || props)
                          ...
                          ' to calculate the next version. This is an awesome way to accomplish automated releases, but it is very strict and can create more work when accepting outside contribution. PR labels solve this problem beautifully, but...'
                        ),
                        P,
                        N
                      )
                      ...
                      c(
                        ...
                        c(
                          ...
                          c(
                            ...
                            {},
                            void 0,
                            "That's exactly why we made the ",
                            c(
                              u,
                              {
                                currentPage: ((this && this.props) || props)
                            ...
                            '. It allows you to keep your conventional commit work flow but still get the benefits of PR labels based automation.'
                          ),
                          I,
                          _,
                          C
